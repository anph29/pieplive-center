...
class Auth:
    ...
    def sign_in_with_phone_number(self, phoneNumber):
        request_ref = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPhoneNumber?key={0}".format(self.api_key)
        headers = {"content-type": "application/json; charset=UTF-8"}
        data = json.dumps({"phoneNumber":phoneNumber, "returnSecureToken": True})
