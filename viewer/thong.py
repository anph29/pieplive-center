...
class Player(Tk.Frame):
    ...
    def __init__(self, parent, title=None):
        ...
        self.video1 = ttk.Frame(self.videopanel)
        self.mycanvas = Tk.Canvas(self.video1,width=1280, height=720).pack(fill=Tk.BOTH)
        self.video1.pack(fill=Tk.BOTH)
        # self.video2 = ttk.Frame(self.videopanel)
        # self.canvas = Tk.Canvas(self.video2).pack(fill=Tk.BOTH)
        # self.video2.pack(side=Tk.LEFT)

        self.player.set_media(self.Instance.media_new("rtsp://viewer:FB1D2631C12FE8F7EE8951663A8A108@113.176.112.174:554"))
        self.player.play() # hit the player button
        self.player.set_hwnd(self.video1.winfo_id())

        # self.player1.set_media(self.Instance.media_new("rtsp://viewer:FB1D2631C12FE8F7EE8951663A8A108@113.176.112.174:554"))
        # self.player1.play() # hit the player button
        # self.player1.set_hwnd(self.video2.winfo_id())
        
        ctrlpanel = ttk.Frame(self.parent)
        pause  = ttk.Button(ctrlpanel, text="Pause", command=self.OnPause)
        stream  = ttk.Button(ctrlpanel, text="Stream", command=self.OnStream)
        stopstream  = ttk.Button(ctrlpanel, text="Stop Stream", command=self.StopStream)
    ...
    def OnStream(self):
        self.rect = win32gui.GetWindowRect(self.video1.winfo_id())
